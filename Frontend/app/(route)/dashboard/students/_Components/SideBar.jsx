...
const Sidebar = () => {
  ...
  const studentsMenuItems = [
    { path: '/dashboard/students/overview', icon: LayoutDashboard, label: 'Overview' },
    { path: '/dashboard/students/notices', icon: Bell, label: 'View Notice' },
    { path: '/dashboard/students/download-resources', icon: Upload, label: 'Download Resources' },
    { path: '/dashboard/students/events', icon: Calendar, label: 'Events' },
    { path: '/dashboard/students/ask-faculty', icon: CircleQuestionMarkIcon, label: 'Ask Faculty' },
  ];
         ...
         {studentsMenuItems.map((item) => {
           ...
           return (
            ...
            className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-all duration-300 ${
              isActive
                ? ' bg-emerald-600/20 text-green-400 '
